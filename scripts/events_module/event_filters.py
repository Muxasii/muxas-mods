...
def event_for_cat(
    ...
    func_lookup = {
        ...
        "species": _check_cat_species,
        "wing_count": _check_cat_wing_count,
        "perm_condition": _check_cat_perm_condition,
        "perm_condition_restraint": _check_cat_perm_condition_restraint,
...
def _check_cat_perm_condition(cat, permanent_condition: list) -> bool:
    if "any" in permanent_condition or not permanent_condition:
        return True

    if cat.permanent_condition in permanent_condition:
        return True
    
    return False
def _check_cat_perm_condition_restraint(cat, permanent_condition: list) -> bool:
    if "any" in permanent_condition:
        return False
