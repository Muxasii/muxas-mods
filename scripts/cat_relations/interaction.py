...
def cats_fulfill_single_interaction_constraints(
    ...
    main_constraint_dict = {
        ...
        "species": interaction.main_species_constraint,
        "wing_count": interaction.main_wing_count_constraint,
        "perma_con": interaction.main_perma_con_constraint,
        "perma_re": interaction.main_perma_con_restraint,
    ...
    random_constraint_dict = {
        ...
        "species": interaction.random_species_constraint,
        "wing_count": interaction.random_wing_count_constraint,
        "perma_con": interaction.random_perma_con_constraint,
        "perma_re": interaction.random_perma_con_restraint,
