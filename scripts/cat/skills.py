...
class CatSkills:
    ...
    @staticmethod
    def generate_new_catskills(wing_count,
    ...
    @staticmethod
    def get_skills_from_old(old_skill, wing_count, rank: CatRank, age: CatAge):
        ...
        if old_skill in conversion:
            ...
            new_skill = CatSkills.generate_new_catskills(rank, age, wing_count)
