...
class Cat:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (
            ...
            self.init_faded(ID, status_dict, species, wing_count, display_wing_count, prefix, suffix, moons, **kwargs)
            return
    ...
    def init_generate_cat(self, skill_dict, disable_random):
        ...
        if not skill_dict:
            self.skills = CatSkills.generate_new_catskills(self.status.rank, self.moons, self.wing_count)
    ...
    def get_permanent_condition(self, name, born_with=False, event_triggered=False):
        ...
        if "lost a wing" in self.permanent_condition and name in ["lost a wing", "lost their wings"]: 
        ...
        if self.wing_count == 1 and ("born with one wing" in self.permanent_condition and name == "lost a wing"):
